...
alias ctf='cd /root/Documents/CTF/Pico'
alias forensics='cd /root/CTF-Tools/forensic'
alias crypto='cd /root/CTF-Tools/crypto'
alias reverse='cd /root/CTF-Tools/reversing'
alias network='cd /root/CTF-Tools/networking'
alias stegno='cd /root/CTF-Tools/stegno'
